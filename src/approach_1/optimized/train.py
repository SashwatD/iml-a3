...
def train_model(
    ...
    image_size=(224, 224),
    embedding_dim=300,
    embedding_type="tfidf" # "tfidf", "glove", "word2vec", "fasttext"
):
    ...
    if embedding_type == "tfidf":
        ...
        if embedding_type == "glove": model_name = "glove-wiki-gigaword-300"
    ...
    # AdamW + Grad Clipping
    # CRITICAL: Optimizer must update BOTH model and loss weights
    ...
    for epoch in range(epochs):
        ...
        for imgs, captions, emotions in loop:
            ...
            # Raw Losses (Don't weight them manually!)
